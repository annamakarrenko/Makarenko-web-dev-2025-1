    ...
    sortedOrders.forEach((order, index) => {
        ...
        html += `
            <tr data-order-id="${order.id}">
                ...
                <td class="order-delivery-time">${deliveryTime}</td>
    ...
    let html = `
        ...
        <div class="order-info-section">
            ...
            <div class="info-row">
                ...
                <div class="info-value">${formatDeliveryTime(order)}</div>
            </div>
            <div class="info-row">
    ...
    html += `
        ...
        <div class="modal-buttons">
            <button class="action-btn" 
                onclick="hideModal('view-modal')">ОК</button>
        </div>
    `;
...
function editOrder(orderId) {
    ...
    // Создаем переменные для checked атрибутов
    const nowChecked = order.delivery_type === 'now' 
        ? 'checked' 
        : '';
    
    const byTimeChecked = order.delivery_type === 'by_time' 
        ? 'checked' 
        : '';
    ...
    let html = `
        ...
        <form id="edit-order-form" class="edit-form">
            ...
            <div class="edit-form-section">
                <div class="edit-row">
                    <div class="edit-label">Дата оформления:</div>
            ...
            <div class="edit-form-section">
                ...
                <div class="edit-row" id="delivery-time-row" 
                    style="${isByTime ? '' : 'display: none;'}">
